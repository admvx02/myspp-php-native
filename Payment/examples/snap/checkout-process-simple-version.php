...
Config::$serverKey = 'SB-Mid-server-rFnS0RomKoxK5UdoQhnCO4D_';
Config::$clientKey = 'SB-Mid-client-fhcvHUjogbaR0cSB';
...
<body>
    ...
    <div class="container">
        <div class="card">
            <div class="card-body">
                <p>Konfirmasi Berhasil, Selesaikan Pembayaran Sekarang</p>
